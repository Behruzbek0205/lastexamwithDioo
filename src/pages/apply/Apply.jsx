  ...
  return (
    <div>
      ...
      <div className="px-4 md:px-6 lg:px-8 py-6">
        <div className="twodivs justify-center flex flex-col  lg:flex-row gap-6 lg:gap-12">
          <div className="card w-full lg:w-[536px] flex flex-col gap-3.5">
            ...
            {cart.map((item) => {
              ...
              return (
                <div
                  className="cartlar flex flex-col sm:flex-row items-center gap-3 w-full border-2 border-[#A3A3A3] rounded-md p-3"
                  key={item.id}
                >
                  <img
                    src={item.image}
        ...
        <div className="w-full max-w-[1120px] mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 mt-25">
