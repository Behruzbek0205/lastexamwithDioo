...
import { Dataa } from "../../alldata/data";
...
const Apple = () => {
  return (
    <div className="px-4 md:px-6 lg:px-8">
      <hr className="text-[#B5B5B5] w-[1521px] relative -left-8" />
      ...
      <div className="main flex flex-col lg:flex-row lg:gap-8">
        ...
        <div className="map w-full h-auto mt-4 md:mt-10 lg:flex-1">
          <div className="top flex -mt-4 flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="card grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mt-6">
            {Dataa.map((item, index) => (
              <div
                ...
                key={index}
              >
                <FaHeart className="text-2xl md:text-[29px] self-end mr-6 cursor-pointer text-[#909090C4]" />
